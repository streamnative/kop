...
@Slf4j
public abstract class KopCommandDecoder extends ChannelInboundHandlerAdapter {
    protected ChannelHandlerContext ctx;
    protected SocketAddress remoteAddress;
    // TODO: do we need keep alive? if need, messageReceived() before every command is need?

    public KopCommandDecoder() {
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try (KafkaHeaderAndRequest kafkaHeaderAndRequest = byteBufToRequest(buffer)){
            ...
            log.info("[{}] released buffer - {} after handle command. refCnt: {}",
