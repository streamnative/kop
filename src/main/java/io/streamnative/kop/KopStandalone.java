...
@Slf4j
public class KopStandalone implements AutoCloseable {
    KopService kopBroker;
    PulsarAdmin admin;
    LocalBookkeeperEnsemble bkEnsemble;
    KopServiceConfiguration config;

    public void setKopBroker(KopService kopBroker) {
        this.kopBroker = kopBroker;
    }
    ...
    public void setConfig(KopServiceConfiguration config) { this.config = config; }
    ...
    @Parameter(names = { "--no-kopBroker" }, description = "Only start ZK and BK services, no kopBroker")
    private boolean noBroker = false;

    @Parameter(names = { "--only-kopBroker" }, description = "Only start Pulsar kopBroker service (no ZK, BK)")
    ...
    @Parameter(names = { "-a", "--advertised-address" }, description = "Standalone kopBroker advertised address")
    ...
    public void start() throws Exception {
        ...
        log.info("--- setup KopStandaloneStarter ---");
        ...
        // Start Broker
        kopBroker = new KopService(config);
        kopBroker.start();
