---
download: "https://github.com/streamnative/kop/releases/download/v2.9.0.0-rc-3/pulsar-protocol-handler-kafka-2.9.0.0-rc-3.nar"
...
1. Download KoP protocol handler, or build the `./kafka-impl/target/pulsar-protocol-handler-kafka-2.9.0.0-rc-3.nar` file, and then copy it to your Pulsar `protocols` directory.
...
3. Get the `.nar` file in the following directory and copy it your Pulsar `protocols` directory. You need to create the `protocols` folder in Pulsar if it's the first time you use protocol handlers.
    ...
    ```bash
    ./kafka-impl/target/pulsar-protocol-handler-kafka-2.9.0.0-rc-3.nar
    ```
...
- [Configure KoP](https://github.com/streamnative/kop/blob/branch-2.9.0.0-rc-3/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/branch-2.9.0.0-rc-3/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/branch-2.9.0.0-rc-3/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/branch-2.9.0.0-rc-3/docs/implementation.md)
