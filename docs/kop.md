---
download: "https://github.com/streamnative/kop/releases/download/v2.8.2.9/pulsar-protocol-handler-kafka-2.8.2.9.nar"
...
1. Download KoP protocol handler, or build the `./kafka-impl/target/pulsar-protocol-handler-kafka-2.8.2.9.nar` file, and then copy it to your Pulsar `protocols` directory.
...
3. Get the `.nar` file in the following directory and copy it your Pulsar `protocols` directory. You need to create the `protocols` folder in Pulsar if it's the first time you use protocol handlers.
    ...
    ```bash
    ./kafka-impl/target/pulsar-protocol-handler-kafka-2.8.2.9.nar
    ```
...
-   [Configure KoP](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/configuration.md)
-   [Monitor KoP](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/reference-metrics.md)
-   [Upgrade](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/upgrade.md)
-   [Secure KoP](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/security.md)
-   [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/envoy-proxy.md)
-   [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/branch-2.8.2.9/docs/implementation.md)
