---
download: "https://github.com/streamnative/kop/releases/download/v2.8.1.2/pulsar-protocol-handler-kafka-2.8.1.2.nar"
...
- [Configure KoP](https://github.com/streamnative/kop/blob/branch-2.8.1.2/docs/configuration.md)
- [Secure KoP](https://github.com/streamnative/kop/blob/branch-2.8.1.2/docs/security.md)
- [Manage KoP with the Envoy proxy](https://github.com/streamnative/kop/blob/branch-2.8.1.2/docs/envoy-proxy.md)
- [Implementation: How to converse Pulsar and Kafka](https://github.com/streamnative/kop/blob/branch-2.8.1.2/docs/implementation.md)
