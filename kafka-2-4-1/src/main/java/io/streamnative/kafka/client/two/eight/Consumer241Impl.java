...
/**
 * The implementation of Kafka consumer 2.4.1.
 */
public class Consumer241Impl<K, V> extends KafkaConsumer<K, V> implements Consumer<K, V> {

    public Consumer241Impl(final ConsumerConfiguration conf) {
