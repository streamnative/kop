...
/**
 * The implementation of Kafka producer 2.4.1.
 */
public class Producer241Impl<K, V> extends KafkaProducer<K, V> implements Producer<K, V> {

    public Producer241Impl(final ProducerConfiguration conf) {
