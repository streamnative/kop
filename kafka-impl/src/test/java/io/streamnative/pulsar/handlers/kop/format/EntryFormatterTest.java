...
public class EntryFormatterTest {
    ...
    private void init() {
        ...
        pulsarFormatter = EntryFormatterFactory.create(pulsarServiceConfiguration, null, pulsarServiceConfiguration.getEntryFormat());
        kafkaV1Formatter = EntryFormatterFactory.create(KafkaV1ServiceConfiguration, null, KafkaV1ServiceConfiguration.getEntryFormat());
        kafkaMixedFormatter = EntryFormatterFactory.create(kafkaMixedServiceConfiguration, null, kafkaMixedServiceConfiguration.getEntryFormat());
    }
