...
public class MetadataUtilsTest {
    ...
    public void testCreateKafkaMetadataIfMissing() throws Exception {
        ...
        verify(mockNamespaces, times(1)).setRetention(eq(conf.getKafkaMetadataTenant() + "/" + conf.getKafkaMetadataNamespace()), any(RetentionPolicies.class));
        ...
        TenantInfo partialTenant = new TenantInfo(Sets.newHashSet(conf.getSuperUserRoles()), Sets.newHashSet("other-cluster"));
        ...
        doReturn(incompleteOffsetPartitionList).when(mockTopics).getList(eq(conf.getKafkaMetadataTenant() + "/" + conf.getKafkaMetadataNamespace()));
    ...
    @Test(timeOut = 20000)
    public void testCreateKafkaMetadataIfMissingFixes() {
