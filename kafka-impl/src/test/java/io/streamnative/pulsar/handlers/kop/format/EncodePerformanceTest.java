...
public class EncodePerformanceTest {
    ...
    private static void runSingleTest(final MemoryRecords records, final String description, final int repeatTimes) {
        ...
        final EntryFormatter pulsarFormatter = EntryFormatterFactory.create(pulsarServiceConfiguration, null, pulsarServiceConfiguration.getEntryFormat());
        final EntryFormatter kafkaV1Formatter = EntryFormatterFactory.create(KafkaV1ServiceConfiguration, null, pulsarServiceConfiguration.getEntryFormat());
        final EntryFormatter kafkaMixedFormatter = EntryFormatterFactory.create(kafkaMixedServiceConfiguration, null, pulsarServiceConfiguration.getEntryFormat());
