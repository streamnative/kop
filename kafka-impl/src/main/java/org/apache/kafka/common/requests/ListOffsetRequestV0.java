    ...
    private static final Schema LIST_OFFSET_REQUEST_V2 = new Schema(
            ...
            new Field(ISOLATION_LEVEL_KEY_NAME, INT8,
                    "This setting controls the visibility of transactional records. "
                            ...
                            + "With READ_COMMITTED (isolation_level = 1), non-transactional and COMMITTED "
                            + "transactional records are visible. To be more concrete, READ_COMMITTED returns all "
                            + "data from offsets smaller than the current LSO (last stable offset), "
                            + "and enables the inclusion of the list of aborted transactions in the "
