...
//     *
//     * If the topic is migrated from Kafka, then the Kafka migration offset is added to the managed ledger offset.
...
//        long kafkaOffset = 0;
//        if (migrationMetadata != null && migrationMetadata.getMigrationOffset() != -1) {
//            kafkaOffset = migrationMetadata.getMigrationOffset();
//        }
//        long pulsarOffset = ((ManagedLedgerInterceptorImpl) managedLedger.getManagedLedgerInterceptor()).getIndex();
//        return kafkaOffset + pulsarOffset;
