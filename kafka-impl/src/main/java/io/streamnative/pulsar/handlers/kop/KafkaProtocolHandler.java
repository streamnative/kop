...
import io.streamnative.pulsar.handlers.kop.migration.workflow.ManagedLedgerPropertiesWorkflowManager;
...
public class KafkaProtocolHandler implements ProtocolHandler, TenantContextManager {
    ...
    private MigrationWorkflowManager migrationWorkflowManager;
